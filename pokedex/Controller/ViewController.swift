...
class ViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UISearchBarDelegate {
    ...
    // Starts or pauses music when the button is pressed
    ...
    // Dismisses the keyboard when search button is clicked
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        view.endEditing(true)
    }
    
    // Updates the filteredPokemon array with objects that match the search
    ...
    // Happens before segue occurs, sets data up to be passed between view controllers
